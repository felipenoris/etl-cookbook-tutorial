...
nas pastas [`../examples-pyarrow`](../examples-pyarrow) e [`../examples-DuckDB`](../examples-DuckDB).
...
- [pyarrow — documentação oficial](https://arrow.apache.org/docs/python/index.html) — útil para entender o que existe por baixo dos `ArrowDtype`; explorado a fundo na pasta [`../examples-pyarrow`](../examples-pyarrow).
