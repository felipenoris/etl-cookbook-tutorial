...
- `compute_customer_running_spend(batch, threshold_prata=500.0, threshold_ouro=2000.0)`
  ...
  de [`../examples-pandas`](../examples-pandas/examples/10_sequential_stateful_loop.py),
  [`../examples-pyarrow`](../examples-pyarrow/examples/11_sequential_stateful_loop.py) e
  [`../examples-DuckDB`](../examples-DuckDB/examples/15_sequential_stateful_loop.py) — que
...
ao exemplo `../examples-DuckDB/examples/04_memory_limit_and_spill.py`), enriquece com
